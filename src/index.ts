...
import { MAIN_QUICK_REPLY } from "./services/line.service"; // ดึงตัวแปรมาใช้
    ...
    if (!isRegistered) {
      await client.replyMessage(event.replyToken, {
        ...
        contents: {
          ...
          hero: {
            type: "image",
            url: "https://images.unsplash.com/photo-1543362906-ac1b9642f56b?w=800&q=80",
            size: "full",
            aspectRatio: "20:13",
            aspectMode: "cover",
          },
          body: {
            ...
            contents: [
              ...
              {
                type: "text",
                text: "AI ผู้ช่วยดูแลโภชนาการส่วนตัว",
                size: "sm",
                color: "#aaaaaa",
              },
              ...
              {
                type: "text",
                text: "กรุณาตั้งค่าข้อมูลร่างกายและกิจกรรมประจำวัน เพื่อเริ่มใช้งานครับ",
                wrap: true,
                margin: "md",
                size: "sm",
              },
  ...
  // 💬 Message Event
        ...
        contents: {
          ...
          body: {
            ...
            contents: [
              ...
              {
                type: "text",
                text: "ระบบต้องใช้ข้อมูลส่วนตัวเพื่อคำนวณแคลอรี่ครับ",
                size: "sm",
                wrap: true,
                margin: "sm",
              },
    ...
    if (event.message.type === "image") {
      ...
      if (isMenuRequest) {
        ...
        else if (text.includes("เที่ยง") || text.includes("กลางวัน"))
          mealType = "Lunch";
